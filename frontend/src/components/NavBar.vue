        ...
        <div class="grid justify-items-center grid-cols-6 gap-4 max-w-7xl mx-auto h-full">
            <div v-for="item in menu" :key="item.label">
                <component
                    ...
                    class="flex items-center h-14 px-2 transition-colors text-gray-900 hover:text-blue-900 dark:text-white dark:hover:text-sky-500 cursor-pointer hover:font-semibold"
                    target="_blank"
